...
${OBJECTDIR}/src/NonblockingServer.o: src/NonblockingServer.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinc -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/NonblockingServer.o src/NonblockingServer.cpp
...
${OBJECTDIR}/src/Protocol.o: src/Protocol.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinc -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Protocol.o src/Protocol.cpp
...
${OBJECTDIR}/src/Socket.o: src/Socket.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinc -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Socket.o src/Socket.cpp

${OBJECTDIR}/src/ThreadedServer.o: src/ThreadedServer.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinc -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ThreadedServer.o src/ThreadedServer.cpp

${OBJECTDIR}/src/main.o: src/main.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinc -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.cpp
...
${OBJECTDIR}/src/NonblockingServer_nomain.o: ${OBJECTDIR}/src/NonblockingServer.o src/NonblockingServer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinc -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/NonblockingServer_nomain.o src/NonblockingServer.cpp;\
	else  \
...
${OBJECTDIR}/src/Protocol_nomain.o: ${OBJECTDIR}/src/Protocol.o src/Protocol.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinc -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Protocol_nomain.o src/Protocol.cpp;\
	else  \
...
${OBJECTDIR}/src/Socket_nomain.o: ${OBJECTDIR}/src/Socket.o src/Socket.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinc -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Socket_nomain.o src/Socket.cpp;\
	else  \
...
${OBJECTDIR}/src/ThreadedServer_nomain.o: ${OBJECTDIR}/src/ThreadedServer.o src/ThreadedServer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinc -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ThreadedServer_nomain.o src/ThreadedServer.cpp;\
	else  \
...
${OBJECTDIR}/src/main_nomain.o: ${OBJECTDIR}/src/main.o src/main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinc -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main_nomain.o src/main.cpp;\
	else  \
