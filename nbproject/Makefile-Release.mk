...
${OBJECTDIR}/src/FramedTransport.o: src/FramedTransport.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FramedTransport.o src/FramedTransport.cpp
...
${OBJECTDIR}/src/MemoryBuffer.o: src/MemoryBuffer.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MemoryBuffer.o src/MemoryBuffer.cpp
...
${OBJECTDIR}/src/FramedTransport_nomain.o: ${OBJECTDIR}/src/FramedTransport.o src/FramedTransport.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FramedTransport_nomain.o src/FramedTransport.cpp;\
	else  \
...
${OBJECTDIR}/src/MemoryBuffer_nomain.o: ${OBJECTDIR}/src/MemoryBuffer.o src/MemoryBuffer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MemoryBuffer_nomain.o src/MemoryBuffer.cpp;\
	else  \
